const blob = new Blob(['importScripts("https://theo.monster/newrecipe/worker.js");']);
...
const initLangSelector = () => {
    select = new SlimSelect({
        ...
        onChange: (e) => {
            ...
            document.title = e.text && e.text !== 'Plain Text' ? `Creating New ${e.text} Recipe` : 'NoPaste';
...
const webview = (dataToCopy) => {
    window.open(location.href.replace('newrecipe', 'recipes').replace('?l=html', ''));
};
